...
export { PropiedadLocal } from './propiedad-local.entity';
export { PropiedadOficina } from './propiedad-oficina.entity';
export { PropiedadCampo } from './propiedad-campo.entity';
export { PropiedadPH } from './propiedad-ph.entity';
export { PropiedadPozo } from './propiedad-pozo.entity';
