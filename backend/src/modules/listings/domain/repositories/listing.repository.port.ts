...
export abstract class ListingRepositoryPort {
  abstract save(listing: ListingAggregate): Promise<ListingAggregate>;
  ...
  abstract findById(id: number): Promise<ListingAggregate | null>;

  abstract findBySlug(slug: string): Promise<ListingAggregate | null>;
